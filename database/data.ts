const data: Record<TProductId, TProduct> = {
  ...
  '6trfgkkj': {
    ...
    attributes: {
      description:
        'Shredded meat has always been quite popular in areperas and its combination with yellow cheese is one of the most requested. It bears that name because of the strands of meat and cheese that seem to add hair to the arepa.',
  ...
  '7bcr49em': {
    ...
    attributes: {
      description:
        "This combination of beans with hard white cheese is also common in empanadas and one of the oldest inside an arepa. The cheese is usually quite salty and the beans little salty or sweet, to achieve a delicious contrast.",
  ...
  '098323ks': {
    ...
    attributes: {
      description:
        'Some shellfish supposedly have aphrodisiac properties. That is why various mixtures of seafood bear this name, usually in vinaigrette or oil, to fill the toast: pepitonas, shrimp, squid, chipi-chipi, octopus, guacuco, etc.',
  ...
  b8uthe2y: {
    ...
    attributes: {
      description:
        "Pieces of delicious baked ham with grated yellow cheese. It takes its name from the Caracas tradition of seeking asylum in an arepera, late in the morning, after a good party.",
  ...
  ewxsd6xb: {
    ...
    attributes: {
      description:
        'The typical Venezuelan dish is taken to the arepa with plantain, beans, shredded meat and grated hard white cheese. This dish carries the essence of the Venezuelan and is a challenge that conquers foreign palates.',
  ...
  fpr72m9k: {
    ...
    attributes: {
      description:
        "This preparation of scrambled eggs with tomato, sweet pepper and chopped onion, with a little salt, is typical in Venezuelan breakfasts and can be found as a filling in any arepera.",
  ...
  t9dv25gs: {
    ...
    attributes: {
      description:
        'It is a Venezuelan adaptation of the American hamburger: instead of having a wheat bun with a sesame seed topping, an open arepa contains all the ingredients of the classic hamburger.',
