const data: Record<TProductId, TProduct> = {
  ...
  ewxsd6xb: {
    ...
    attributes: {
      description:
        'The typical Venezuelan dish is taken to the arepa with slices, beans, shredded meat and grated hard white cheese. This dish carries the essence of the Venezuelan and is a challenge that conquers foreign palates.',
      shape: 'Modificar',
      hardiness: 'Eliminar',
